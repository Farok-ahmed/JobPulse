				...
				<div class="condidate-slider owl-carousel owl-theme">
					<div class="condidate-item">
						<div class="candidate-img">
							<img src="{{asset('frontend/assets/')}}/img/candidate/1.jpg" alt="candidate image">
						</div>
					...
					<div class="condidate-item">
						<div class="candidate-img">
							<img src="{{asset('frontend/assets/')}}/img/candidate/2.jpg" alt="candidate image">
						</div>
						<div class="candidate-social">
							<a href="#" target="_blank"><i class='bx bxl-facebook'></i></a>
							<a href="#" target="_blank"><i class='bx bxl-twitter'></i></a>
					...
					<div class="condidate-item">
						<div class="candidate-img">
							<img src="{{asset('frontend/assets/')}}/img/candidate/3.jpg" alt="candidate image">
						</div>
						<div class="candidate-social">
							<a href="#" target="_blank"><i class='bx bxl-facebook'></i></a>
							<a href="#" target="_blank"><i class='bx bxl-twitter'></i></a>
					...
					<div class="condidate-item">
						<div class="candidate-img">
							<img src="{{asset('frontend/assets/')}}/img/candidate/4.jpg" alt="candidate image">
						</div>
						<div class="candidate-social">
							<a href="#" target="_blank"><i class='bx bxl-facebook'></i></a>
							<a href="#" target="_blank"><i class='bx bxl-twitter'></i></a>
