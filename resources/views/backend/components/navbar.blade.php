            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{route('admin.applications')}}" data-key="t-read-email">Job Applications</a></li>
                    </ul>
                </li>
                ...
                <li><a class="dropdown-item" href="{{route('profile.edit')}}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Profile</a></li>
                <li>
